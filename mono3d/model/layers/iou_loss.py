...
class IOULoss(nn.Module):
    ...
    def forward(self, pred, target, weight=None):
        ...
        pred_area = (pred_left + pred_right).clamp(0.) * \
                    (pred_top + pred_bottom).clamp(0.)
        ...
        w_intersect.clamp_(0.)
        h_intersect.clamp_(0.)
        g_w_intersect.clamp_(0.)
        g_h_intersect.clamp_(0.)
