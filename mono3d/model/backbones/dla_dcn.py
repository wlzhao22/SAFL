...
class CustomDLASeg(nn.Module):
    def __init__(self, base_name, pretrained, down_ratio, last_level, in_channels=3, use_dcn=True, dropblock_cfg=None):
        super(CustomDLASeg, self).__init__()
