...
def clean_data(gt_anno, dt_anno, current_class, difficulty):
    ...
    MIN_HEIGHT = [25, 25]
    ignore_condition = lambda o, t, d: (o == 0 and t == 0) if d == 0 else (o in (1, 2) or t > 0)
    ...
    for i in range(num_gt):
        ...
        if (
            (
                not ignore_condition(gt_anno['occluded'][i], gt_anno['truncated'][i], difficulty)
            )
...
def kitti_eval(gt_annos,
    ...
    ret_dict = {}
    difficulty = ['fully_visible', 'occluded/truncated']
