...
from tools.data_converter import kitti_tracking_converter as kitti_tracking
import tools.data_converter.kitti_raw_converter as kitti_raw
...
def kitti_raw_data_prep(root_path, info_prefix):
    kitti_raw.create_kitti_raw_info_file(root_path, info_prefix)


def kitti_tracking_data_prep(root_path, info_prefix, version, out_dir):
    kitti_tracking.create_kitti_tracking_info_file(root_path, info_prefix)
