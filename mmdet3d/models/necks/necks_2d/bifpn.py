...
from ...utils.utils_2d.efficientdet_utils import ConvBlock, MemoryEfficientSwish, Swish
from ...utils.utils_2d.utils_extra import MaxPool2dStaticSamePadding, Conv2dStaticSamePadding
...
class bifpn(nn.Module):
    ...
    def __init__(self, num_channels, conv_channels, first_time=False, epsilon=1e-4, onnx_export=False, attention=True,
        ...
        # self.p6_upsample = nn.Upsample(size=(8,8), mode='nearest')
        # self.p5_upsample = nn.Upsample(size=(16,16), mode='nearest')
        # self.p4_upsample = nn.Upsample(size=(32,32), mode='nearest')
        # self.p3_upsample = nn.Upsample(size=(64,64), mode='nearest')
...
class BiFPN(nn.Module):
    def __init__(self, 
        compound_coef: int, 
        fpn_num_filters: int, 
        conv_channel_coef: int, 
        fpn_cell_repeats: int, 
        onnx_export=False
    ):
        super(BiFPN, self).__init__()
        self.fpn_cell_repeats = fpn_cell_repeats
        self.bifpn_0 = nn.Sequential(
            *[bifpn(fpn_num_filters,
                    conv_channel_coef,
