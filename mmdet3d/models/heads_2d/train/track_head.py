...
class TrackHead(nn.Module):
    ...
    def forward_single(self, embeddings):
        outputs = {}
        outputs[OUTPUT_TRACK_EMBEDDING] = self.embedding_head(embeddings[0])
    ...
    def forward_train(self, inputs, outputs):
        ...
        outputs[OUTPUT_TRACK_EMBEDDING_REF] = self.forward_single(outputs[OUTPUT_FEATURE_REF])[OUTPUT_TRACK_EMBEDDING]
    ...
    def loss(self, inputs, outputs):
        ...
        bbox_preds, embedding_preds = outputs[OUTPUT_DETECTION_YOLO_BOX_LIST].detach(), outputs[OUTPUT_TRACK_EMBEDDING]
        ...
        bbox_preds_ref, embedding_preds_ref = outputs[OUTPUT_DETECTION_YOLO_BOX_LIST_REF].detach(), outputs[OUTPUT_TRACK_EMBEDDING_REF]
