...
# from tracking_utils.decode import mot_decode
# from tracking_utils.decode import _tranpose_and_gather_feat
from .utils import *
...
class JDETracker(object):
    def __init__(self, conf_thres, mean, std, num_classes, frame_rate=30, track_buffer=30,K=100):
    ...
    def update(self, dets, id_feature):
        ...
        matches, u_track, u_detection = linear_assignment(dists, thresh=0.65)
        ...
        matches, u_track, u_detection = linear_assignment(dists, thresh=0)
