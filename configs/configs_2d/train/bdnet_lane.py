...
gpus = 11
collect_keys=['img', "gt_bboxes_2d", "gt_labels", "img_aug", "gt_free_space", "gt_lane_seg", "gt_lane_exist", "img_affine", "gt_free_space_resized"]
...
train_pipeline = [
    dict(type='LoadImageFromFile', with_mixup=True),
    dict(type='LoadAnnotations', with_affine=True, with_bbox2d=True, with_label=True, with_laneSeg=True, with_free_space=True, with_mixup=True),
    dict(type='MixUp'),
...
load_from = '/home/boden/Dev/ws/ws/BDNet_solo_lane/work_dirs/20210602/epoch_5.pth'
# load_from = None
resume_from = None

work_dir = '/home/boden/Dev/ws/ws/BDNet_solo_lane/work_dirs/20210602'
