...
model = dict(
    ...
    head_cfg=dict(
        ...
        loss_names=['hm_loss', 'bbox_l1_loss', 'bbox_iou_loss', 'depth_loss', 'offset_loss', 'orien_loss', 'dims_loss', 'corner_loss', 'keypoint_loss', 'keypoint_depth_loss', 'trunc_offset_loss', 'weighted_avg_depth_loss', 'seg_loss'],
        init_loss_weight=[1, 0.01, 1, 1, 0.5, 1, 1, 0.2, 1.0, 0.2, 0.1, 0.2, 2.],
        test_cfg=test_cfg
    )
)
